...
void main() async {
  ...
  // Start mock server
  final mockProcess = await Process.start('dart', [
    'run',
    'bin/mock_truenas_server.dart',
    '8082',
  ]);
...
''');
  ...
  final backendProcess = await Process.start('dart', [
    'run',
    'bin/server.dart',
    '--port',
    '8083',
  ...
  // Wait for processes
  await Future.wait([mockProcess.exitCode, backendProcess.exitCode]);
}
